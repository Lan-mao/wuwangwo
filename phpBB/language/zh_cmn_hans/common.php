...
$lang = array_merge($lang, array(
	'TRANSLATION_INFO'	=> '简体中文语言由 <a href="https://www.g2soft.net/">David Yin</a> 维护',
	'DIRECTION'			=> 'ltr',
	...
	'AJAX_ERROR_TEXT'				=> '当处理您的请求时发生错误。',
	'AJAX_ERROR_TEXT_ABORT'			=> '用户中止请求。',
	'AJAX_ERROR_TEXT_TIMEOUT'		=> '您的请求超时；请重试。',
	...
	'ALL_MESSAGES'					=> '全部短信',
	'ALL_POSTS'						=> '全部帖子',
	'ALL_TIMES'						=> '所有显示的时间是 <span title="%2$s">%1$s</span>',
	'ALL_TOPICS'					=> '全部主题',
	'ALT_TEXT'						=> '替换文本',
	'AND'							=> '和',
	...
	'AVATAR_NO_TEMP_DIR'			=> '临时目录不可写入或者找不到。',
	...
	'AVATAR_PHP_UPLOAD_STOPPED'		=> '一个 PHP 扩展停止了文件上传。',
	...
	'BCC'					=> 'BCC',
	'BIRTHDAYS'				=> '生日',
	'BOARD_BAN_PERM'		=> '您已被此论坛<strong>永久</strong>封禁。<br /><br />请联系 %2$s论坛管理员%3$s 获得更多信息。',
	...
	'BROWSING_FORUM_GUESTS'	=> array(
		1	=> '正浏览此版面之用户： %2$s 和 %1$d 访客',
		2	=> '正浏览此版面之用户： %2$s 和 %1$d 访客',
	),
	'BUTTON_DELETE'         => '删除',
	'BUTTON_EDIT'			=> '编辑',
	...
	'CONFIRM_AVATAR_DELETE' => '您确定要删除此头像吗？',
	'CONGRATULATIONS'		=> '恭喜',
	...
	'CONTACT_USER'			=> '联系 %s',
	'CONTACT_US'			=> '联系我们',
	'COOKIE_CONSENT_INFO'	=> '了解更多',
	'COOKIE_CONSENT_MSG'	=> '本站使用 cookies 以提供用户最佳网站体验。',
	'COOKIE_CONSENT_OK'		=> '明白了！',
	...
	'INDEX'						=> '首页',
	'INFORMATION'				=> '信息',
	'INSECURE_REDIRECT'			=> '尝试重定向至潜在不安全之网址。',
	'INTERESTS'					=> '兴趣',
	'INVALID_DIGEST_CHALLENGE'	=> '无效的摘要需求。',
	'INVALID_EMAIL_LOG'			=> '<strong>%s</strong>可能无效的email地址？',
	'INVALID_FEED_ATTACHMENTS'	=> '所选择的 Feed 尝试用无效的参数来提取附件。',
	...
	'LOGIN_INFO'						=> '您必须注册后才能登录。注册仅需要很短的时间但是会给您更多的权限。在注册前请确认您已经明白我们的使用条款和政策。',
	'LOGIN_INFO_BACKUP'						=> '您必须注册后才能登录。注册仅需要很短的时间但是会给您更多的权限。在注册前请确认您已经明白我们的使用条款和政策。当浏览论坛时请确认您已经阅读过版面规则。',
	'LOGIN_VIEWFORUM'					=> '您必须注册并登录才能浏览这个版面。',
	'LOGIN_EXPLAIN_EDIT'				=> '您必须注册并登录才能编辑版面文章。',
	'LOGIN_EXPLAIN_VIEWONLINE'			=> '要查看在线用户列表，您必须注册并登录。',
	'LOGIN_REQUIRED'					=> '您需要登录执行此操作。',
	'LOGOUT'							=> '退出',
	'LOGOUT_USER'						=> '退出 [ %s ]',
	'LOG_ME_IN'							=> '每次浏览时自动登录',
	...
	'NOTIFICATION_METHOD_INVALID'		=> ' "%s" 不是一个有效的通知方法。',
	...
	'NOTIFICATION_ADMIN_ACTIVATE_USER'	=> '<strong>需要激活</strong>对于新注册或未激活用户: “%1$s”',
	...
	'SORRY_AUTH_READ_TOPIC'		=> '您没有阅读该主题的权限。',
	...
	'USER_NEW_PERMISSION_DISALLOWED'	=> '抱歉!您没有权限使用这个功能。您可能刚在本站注册，等级不够，需要更多的参与到讨论中去才行。',
  ...
  'WRONG_DATA_COLOUR'			=> '您输入的颜色值是无效的.',
	...
	'WRONG_DATA_POST_SD'		=> '您指定的帖子排序方向无效。',
	'WRONG_DATA_POST_SK'		=> '您指定的帖子排序选项无效。',
	'WRONG_DATA_TOPIC_SD'		=> '您指定的主题排序方向无效。',
	'WRONG_DATA_TOPIC_SK'		=> '您指定的主题排序选项无效。',
	'WROTE'						=> '写了',
