...
require_once ($phpbb_root_path . 'includes/aliyun/aliyun-dysms-php-sdk/api_sdk/vendor/autoload.' . $phpEx);
...
class SmsDemo
{
	...
	public static function getAcsClient() {
		...
		$accessKeyId = "LTAI0BWOl6wt82V7"; // AccessKeyId

		$accessKeySecret = "IyNXqWOvEBPZOTtz1EP3GhhKUkQiyF"; // AccessKeySecret
	 ...
	 * @return stdClass
	 */
	public static function sendSms($verifyCode) {
		...
		// 必填，设置短信接收号码
		$request->setPhoneNumbers($verifyCode['emailOrTel']);

		// 必填，设置签名名称，应严格按"签名名称"填写，请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/sign
		$request->setSignName("燃点爱好");

		// 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
		$request->setTemplateCode("SMS_137550095");
