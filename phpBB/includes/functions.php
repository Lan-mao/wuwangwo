...
function page_header($page_title = '', $display_online_list = false, $item_id = 0, $item = 'forum', $send_headers = true)
{
	...
	$template->assign_vars(array(
		...
		'T_STYLESHEET_LINK'      => "{$web_path}styles/" . rawurlencode($user->style['style_path']) . '/theme/rd.css?assets_version=' . $config['assets_version'],
		...
		'T_ADMIN_CKEDITOR_LINK'	=> "{$web_path}styles/prosilver/lib/ckeditor/ckeditor.js?assets_version=" . $config['assets_version'],
		'T_USER_CKEDITOR_LINK'	=> "{$web_path}styles/prosilver/lib/ueditor/ckeditor.js?assets_version=" . $config['assets_version'],
