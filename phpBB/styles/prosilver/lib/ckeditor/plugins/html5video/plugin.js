CKEDITOR.plugins.add('html5video', {
    ...
    init: function (editor) {
        editor.widgets.add('html5video', {
             ...
             */
            allowedContent: 'div[data-responsive](!ckeditor-html5-video){text-align,float,margin-left,margin-right}; video[src,controls,autoplay,loop,width, height]{max-width,height};',
            ...
            init: function () {
                ...
                if (this.element.getChild(0)) {
                    ...
                    loopRd = this.element.getChild(0).getAttribute('loop');
                ...
                if (src) {
                    ...
                    if (loopRd) {
                        this.setData('loopRd', 'yes');
                    } else {
                        this.setData('loopRd', 'no');
                    }
