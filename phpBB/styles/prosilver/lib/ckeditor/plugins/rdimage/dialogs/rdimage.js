...
CKEDITOR.dialog.add( 'rdimage', function( editor ) {
	...
	var regexGetSizeOrEmpty = /(^\s*(\d+)(px)?\s*$)|^$/i,
		...
		helpers = CKEDITOR.plugins.rdimage,
		...
		// Functions inherited from rdimage plugin.
		...
		contents: [
			{
				...
				elements: [
					...
					},
					{
						...
						validate: editor.config.rdimage_altRequired === true ? CKEDITOR.dialog.validate.notEmpty( lang.altMissing ) : null
					},
					{
						type: 'hbox',
						widths: [ '25%', '25%', '50%' ],
